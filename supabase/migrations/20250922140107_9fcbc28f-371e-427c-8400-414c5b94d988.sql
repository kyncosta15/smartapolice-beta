-- Fix function search path issues by updating functions to have proper search_path settings

-- Update generate_protocol_code function
...
-- Update auto_fix_frota_status function
...
-- Update fix_frota_status_outros function
CREATE OR REPLACE FUNCTION public.fix_frota_status_outros()
RETURNS TABLE(veiculos_atualizados integer, placas_alteradas text[])
LANGUAGE plpgsql
SECURITY DEFINER
SET search_path = public
AS $function$
