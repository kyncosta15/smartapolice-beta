...
type NovoTicketModalV3Props = {
  trigger: React.ReactNode
  onTicketCreated?: () => void
  initialTipo?: 'sinistro' | 'assistencia'
}

export function NovoTicketModalV3({ trigger, onTicketCreated, initialTipo = 'sinistro' }: NovoTicketModalV3Props) {
                ...
                {tipoTicket === 'sinistro' ? (
                  <Select value={tipoSinistro} onValueChange={setTipoSinistro}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="invalidez_doenca">Invalidez por Doença</SelectItem>
