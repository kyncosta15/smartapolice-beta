  ...
  return (
    <div className="w-full space-y-8">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        {hasData && (
          <div className="flex items-center space-x-2 px-3 py-1 bg-green-50 dark:bg-green-950/40 rounded-full">
            <TrendingUp className="h-4 w-4 text-green-600 dark:text-green-400" />
            <span className="text-sm font-medium text-green-700 dark:text-green-300">Dados atualizados</span>
          </div>
        )}
      </div>
      ...
      {!hasData && (
        <Card className="border-2 border-dashed border-border bg-muted/20">
          <CardContent className="flex flex-col items-center justify-center py-12">
            <div className="p-3 bg-orange-50 dark:bg-orange-950/40 rounded-full mb-4">
      ...
      {hasData && (
        <div className="mt-8 p-4 bg-blue-50 dark:bg-blue-950/40 rounded-xl">
          <div className="flex items-start space-x-3">
            <BarChart3 className="h-5 w-5 text-blue-600 dark:text-blue-400 mt-0.5" />
            <div>
              <h4 className="font-medium text-blue-900 dark:text-blue-200">Análise Inteligente</h4>
