        ...
        <div className={cn("flex items-center gap-2.5", !open && "justify-center")}>
          ...
          {open && (
            <div className="flex items-baseline leading-none">
              <span className="text-lg font-bold tracking-tight text-foreground">Smart</span>
              <span className="text-lg font-bold tracking-tight bg-gradient-to-r from-[hsl(190,100%,50%)] via-[hsl(220,100%,55%)] to-[hsl(280,100%,55%)] bg-clip-text text-transparent">Control</span>
            </div>
          )}
        </div>
      </SidebarHeader>
