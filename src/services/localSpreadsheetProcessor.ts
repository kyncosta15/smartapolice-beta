  ...
  static toEdgeFunctionFormat(result: LocalProcessResult, empresaId: string): any {
    return {
      veiculos: result.veiculos.map(v => ({
        ...
        proprietario_doc: v.proprietario_doc,
        proprietario_tipo: v.proprietario_tipo,
        ...
        uf_emplacamento: v.uf_emplacamento,
        preco_nf: v.preco_nf,
        preco_fipe: v.preco_fipe,
        data_venc_emplacamento: v.data_venc_emplacamento,
        modalidade_compra: v.modalidade_compra,
